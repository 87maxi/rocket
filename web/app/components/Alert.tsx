...
export default function Alert({
  ...
  return (
    <div
      className={`flex items-center p-4 rounded-lg border ${alertStyles[type]}`}
      role="alert"
    >
      ...
      {onClose && (
        <button
          ...
          className={`ml-auto -mx-1.5 -my-1.5 rounded-lg focus:ring-2 p-1.5 inline-flex h-8 w-8 items-center justify-center hover:bg-black/10 dark:hover:bg-white/10 ${iconStyles[type]}`}
          aria-label="Close"
        >
          <svg
            className="w-4 h-4"
